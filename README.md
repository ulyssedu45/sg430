# Coreboot pour Sophos SG430/XG430/SG450/XG450 Rev 2 / Coreboot for Sophos SG430/XG430/SG450/XG450 Rev 2
...
Port coreboot pour le Sophos SG430/XG430/SG450/XG450 Rev 2, un appareil de sécurité réseau basé sur Intel Skylake.
...
- **Modèle** : Sophos SG430/XG430/SG450/XG450 Rev 2
...
Pour configurer et compiler coreboot pour le SG430/XG430/SG450/XG450 Rev 2, veuillez suivre les instructions officielles de compilation disponibles sur le site de coreboot :

👉 **[Guide officiel de compilation coreboot](https://doc.coreboot.org/tutorial/part1.html)**

**Étapes spécifiques pour le SG430/XG430/SG450/XG450 Rev 2 :**
...
```bash
cp -r chemin/vers/sg430r2 src/mainboard/sophos/
```

3. Lors de la configuration (`make menuconfig`), sélectionner :

   - **Mainboard vendor** : `Sophos`
   - **Mainboard model** : `SG430/XG430/SG450/XG450 Rev 2`
...
Coreboot port for the Sophos SG430/XG430/SG450/XG450 Rev 2, a network security appliance based on Intel Skylake.
...
- **Model**: Sophos SG430/XG430/SG450/XG450 Rev 2
- **Release Year**: 2017
- **Category**: Desktop
- **SOC**: Intel Skylake (Skylake PCH-H)
- **ROM Chip**: SOIC-8
...
To configure and compile coreboot for the SG430/XG430/SG450/XG450 Rev 2, please follow the official compilation instructions available on the coreboot website:

👉 **[Official coreboot build guide](https://doc.coreboot.org/tutorial/part1.html)**

**Specific steps for the SG430/XG430/SG450/XG450 Rev 2:**
